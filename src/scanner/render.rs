...
pub fn render_console(report: &ScanReport, no_color: bool, quiet: bool) -> String {
    ...
    lines.push(c("1;36", "│  github.com/phamlongh230-lgtm/yana-ai          │"));
    lines.push(c("1;36", "└─────────────────────────────────────────────────────┘"));
    lines.push(String::new());
...
pub fn render_markdown(report: &ScanReport) -> String {
    ...
    lines.extend([String::new(), "---".to_string(), String::new(),
        "*Report generated by [Yana AI](https://github.com/phamlongh230-lgtm/yana-ai)*".to_string()]);
    lines.join("\n")
}
    ...
    serde_json::to_string_pretty(&serde_json::json!({
        ...
        "runs": [{
            "tool": { "driver": {
                ...
                "informationUri": "https://github.com/phamlongh230-lgtm/yana-ai",
                "rules": rules_list,
            }},
            "results": results,
