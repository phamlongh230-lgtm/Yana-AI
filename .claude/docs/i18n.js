// Yana AI i18n — shared translation engine for all pages
...
(function () {
  ...
  const T = {
    ...
    skills: {
      en: {
        'page.title': 'Yana AI Library — Skills & Agents',
        'hero.title': 'Yana AI Library',
        ...
        'chip.yana-ai': 'Yana AI Core', 'chip.openai': 'OpenAI Plugins',
        'chip.terminal': 'TerminalSkills', 'chip.venice': 'Venice AI',
        'footer.back': '← yana-ai',
      },
      vi: {
        'page.title': 'Thư viện Yana AI — Skills & Agents',
        'hero.title': 'Thư viện Yana AI',
      ...
      ko: {
        'page.title': 'Yana AI 라이브러리 — 스킬 & 에이전트',
        'hero.title': 'Yana AI 라이브러리',
        ...
        'chip.yana-ai': 'Yana AI 코어', 'chip.openai': 'OpenAI 플러그인',
        'chip.terminal': 'TerminalSkills', 'chip.venice': 'Venice AI',
        'footer.back': '← yana-ai',
      },
    },
    ...
    marketplace: {
      en: {
        'page.title':  'Yana AI Marketplace — Skills & Agents',
        'hero.title':  'Yana AI Marketplace',
      ...
      ko: {
        'page.title':  'Yana AI 마켓플레이스 — 스킬 & 에이전트',
        'hero.title':  'Yana AI 마켓플레이스',
    ...
    guide: {
      en: {
        'page.title':      'Guide — Yana AI',
        'page.h1':         'Yana AI Guide',
        'page.sub':        'Everything you need to install, configure, and run Yana AI.',
        ...
        'h2.scan':         'yana-rt scan',
        'h2.hunt':         'yana-rt hunt',
        'h2.ci':           'yana-rt ci',
        'h2.watch':        'yana-rt watch',
        'h2.init':         'yana-rt init',
        ...
        'p.gates':         'Yana AI intercepts every Claude tool call through a layered gate pipeline:',
        ...
        'p.init':          'Auto-setup Yana AI in any project — creates hooks, config, and settings skeleton in one command.',
        'p.skills':        'Skills are slash commands for Claude Code. With yana-ai installed, 3,457 skills are available.',
        'p.agents':        '95 specialized agents auto-routed by /agent-router. Key agents:',
        'footer.back':     '← yana-ai',
        'footer.built':    'Built by Vũ Văn Tâm · Vietnam',
      },
      vi: {
        'page.title':      'Hướng dẫn — Yana AI',
        'page.h1':         'Hướng dẫn Yana AI',
        'page.sub':        'Mọi thứ cần biết để cài đặt, cấu hình và chạy Yana AI.',
        ...
        'p.gates':         'Yana AI chặn mọi tool call của Claude qua pipeline gate nhiều lớp:',
        ...
        'p.init':          'Tự động cài Yana AI trong bất kỳ project nào — tạo hooks, config và settings skeleton bằng một lệnh.',
        'p.skills':        'Skills là slash commands cho Claude Code. Sau khi cài yana-ai, 3.457 skills sẵn sàng dùng.',
      ...
      ko: {
        'page.title':      '가이드 — Yana AI',
        'page.h1':         'Yana AI 가이드',
        'page.sub':        'Yana AI 설치, 설정, 실행에 필요한 모든 정보.',
        'sidebar.start':   '시작하기',
        ...
        'p.gates':         'Yana AI은 모든 Claude 도구 호출을 다층 게이트 파이프라인으로 차단합니다:',
        ...
        'p.init':          '어떤 프로젝트에든 Yana AI 자동 설치 — 훅, 설정, 세팅 스켈레톤을 한 번에 생성.',
        'p.skills':        '스킬은 Claude Code의 슬래시 명령어입니다. yana-ai 설치 후 3,457개 스킬 사용 가능.',
    ...
    /* ── yana-ai-system-map.html ─────────────────────────────────────── */
    sysmap: {
      en: {
        'page.title': 'Yana AI — System Map',
        'page.h1':    'System Map',
        'page.sub':   'Architecture overview of Yana AI.',
      },
      vi: {
        'page.title': 'Yana AI — Bản đồ hệ thống',
        'page.h1':    'Bản đồ hệ thống',
        'page.sub':   'Tổng quan kiến trúc Yana AI.',
      },
      ko: {
        'page.title': 'Yana AI — 시스템 맵',
        'page.h1':    '시스템 맵',
        'page.sub':   'Yana AI 아키텍처 개요.',
      },
    },
  };

  /* ── State ──────────────────────────────────────────────────────────── */
  let lang = localStorage.getItem('yana-ai-lang') || 'vi';

  /* ── Detect current page ────────────────────────────────────────────── */
  function detectPage() {
    const p = location.pathname.split('/').pop().replace('.html', '') || 'index';
    const MAP = { 'yana-ai-system-map': 'sysmap' };
    return MAP[p] || p;
  }
  ...
  window.setLang = function(l) {
    lang = l;
    localStorage.setItem('yana-ai-lang', l);
    applyI18n();
